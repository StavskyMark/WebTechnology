<!-- https://paiza.io/en for php exec -->
<?php
...
$experience = [
    ['job_name' => 'New Homework Job 1', 
    'job_start_date' => 'Jan 2019', 
    'job_end_date' => 'Current', 
    'job_description' => 'Description 1',
    ],
    ['job_name' => 'New Homework Job 2', 
    'job_start_date' => 'Mar 2016', 
    'job_end_date' => 'Dec 2018', 
    'job_description' => 'Description 2',
    ],
    ['job_name' => 'New Homework Job 3', 
    'job_start_date' => 'Jun 2010', 
    'job_end_date' => 'Mar 2016', 
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $experience[$i]['job_name'] ?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience[$i]['job_start_date'] ?> - <span class="w3-tag w3-teal w3-round"><?php echo $experience[$i]['job_end_date'] ?></span></h6>
          <p><?php echo $experience[$i]['job_description'] ?></p>
          <hr>
        </div>
        <?php endfor; ?>
